...
Cell cycle gene list has been updated in 2019 [Tirosh et al., Science, 2016](https://www.science.org/doi/abs/10.1126/science.aad0501). Cell cycle markers are only
...
FeatureScatter(singlets, "S.Score", "G2M.Score") +
    ggtitle("Default: CC. phase assignation by Seurat") +
