...
length(singlets) - length(filtered_list), "** unwanted cells
have been removed."))
}
```
...
dataset from cells expressing the **`r paste( unlist(ff_list), collapse='', sep=",")`** genes, a RBC marker. It is
equivalent to the removal of
**`r length(singlets) - length(filtered_list)`** unwanted cells
