...
cplt@meta.data[cplt@meta.data$percent.mito > 1, "mito_groups"] <- "gp2_mito"
cplt@meta.data[cplt@meta.data$percent.mito > 5.2, "mito_groups"] <- "gp3_mito"
cplt@meta.data[cplt@meta.data$percent.mito > 15, "mito_groups"] <- "gp4_mito"
cplt@meta.data[cplt@meta.data$percent.mito > 25, "mito_groups"] <- "gp5_mito"


VlnPlot(cplt, features = c("percent.mito")) +
  geom_hline(aes(yintercept = 1), color = "#FF0000AA", size = 1.5) +
  geom_hline(aes(yintercept = 5.2), color = "#FF0000AA", size = 1.5) +
  geom_hline(aes(yintercept = 15), color = "#FF0000AA", size = 1.5) +
  ...
  geom_text(aes(x= 0.5, y=0.5, label = "gp1_mito")) +
  geom_text(aes(x= 0.5, y=3.2, label = "gp2_mito")) +
  geom_text(aes(x= 0.5, y=9, label = "gp3_mito")) +
  geom_text(aes(x= 0.5, y=20, label = "gp4_mito")) +
  geom_text(aes(x= 0.5, y=27, label = "gp5_mito"))
```
...
cplt@meta.data[cplt@meta.data$percent.ribo > 8, "ribo_groups"] <- "gp2_ribo"
cplt@meta.data[cplt@meta.data$percent.ribo > 22, "ribo_groups"] <- "gp3_ribo"

VlnPlot(cplt, features = c("percent.ribo")) +
    geom_hline(aes(yintercept = 8), color = "#FF0000AA", size = 1.5) +
    geom_hline(aes(yintercept = 22), color = "#FF0000AA", size = 1.5) +
    # geom_hline(aes(yintercept = 25), color = "#FF0000AA", size = 1.5) +
    ...
    geom_text(aes(x= 0.5, y=35, label = "gp3_ribo"))
```
...
cplt@meta.data[cplt@meta.data$nCount_RNA > 30000, "umi_groups"] <- "gp3_umi"

VlnPlot(cplt, features = c("nCount_RNA")) +
  geom_hline(aes(yintercept = 7000), color = "#FF0000AA", size = 1.5) +
  geom_hline(aes(yintercept = 30000), color = "#FF0000AA", size = 1.5) +
  # geom_hline(aes(yintercept = 25), color = "#FF0000AA", size = 1.5) +
  ...
  geom_text(aes(x= 0.5, y=50000, label = "gp3_umi"))
```
...
cplt@meta.data[cplt@meta.data$nFeature_RNA > 5500, "feature_groups"] <- "gp3_feature"

VlnPlot(cplt, features = c("nFeature_RNA")) +
    geom_hline(aes(yintercept = 2000), color = "#FF0000AA", size = 1.5) +
    geom_hline(aes(yintercept = 5500), color = "#FF0000AA", size = 1.5) +
    # geom_hline(aes(yintercept = 25), color = "#FF0000AA", size = 1.5) +
    ...
    geom_text(aes(x= 0.5, y=6000, label = "gp3_feature"))
```
