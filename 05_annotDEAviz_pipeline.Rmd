...
dotPlotsMarkers(renamed, topNgenes, title=paste0("Top ", ntop, " markers of each cluster in clusters"))
```

### DotPlot of the genes of interest on cluster identity

```{r cluster-dotPlot-goi}
dotPlotsGoi(renamed, goiList, title="Genes of interest in clusters")
```
...
dotPlotsMarkers(renamed, topNgenes, title=paste0("Top ", ntop, " markers of each cluster in celltypes"))
```
...
dotPlotsGoi(renamed, goiList, title="Genes of interest in celltypes")
```
