...
```{r writeSection-ensemblIDmapping, results='asis', eval=(gn_col == 1), echo=(gn_col==1)}
cat("
...
```{r reduceGeneList, eval=(gn_col == 1), results='asis'}
cat(paste0("
...
```{r load-goiList, eval=!is.null(genes_of_interest), echo=!is.null(genes_of_interest)}
...
```{r clusters-violinPlots-markers, results='asis', out.width='20%', fig.align='default'}
...
```{r set-celltypeIdentity, eval=atlas}
