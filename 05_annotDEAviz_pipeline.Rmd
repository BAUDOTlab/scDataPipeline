...
markers <- FindAllMarkers2(fltd, method="deseq", min_fc = 0)
markers.sign <- markers[markers$padj < 0.001, ]

# Add gene names
markers$gene_name <- corr_table$GeneName[match(markers$feature, corr_table$ENSid)]

markers.sign <- markers[order(-markers$log_fc), ]
