...
```{r cluster-DotPlot-goi, eval=exists("goiList"), echo=exists("goiList")}
...
```{r cluster-FeaturePlot-goi, out.width='20%', fig.align='default', eval=exists("goiList"), echo=exists("goiList")}
