...
### DotPlot of biomarkers in clusters
...
create_dot_plot(fltd, topNgenes, title=paste0("Top ", ntop, " biomarkers of each cluster"))
```

```{r cluster-DotPlot-goi, eval=exists("goiList"), echo=exists("goiList"), results='asis'}
cat("### DotPlot of the genes of interest in clusters
")
...
cat("### DotPlot of the biomarkers on celltype identity")
## DotPlot the n-top biomarkers of each celltype
create_dot_plot(fltd, topNgenes, title=paste0("Top ", ntop, " biomarkers of each cluster in celltypes"))
```
