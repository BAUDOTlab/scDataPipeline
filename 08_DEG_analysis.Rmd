...
Threshold of padj < 0.01 is used to filter the pathways.
...
perform_fgsea_analysis <- function(csv_paths) {
    ## create output folder on name of input file
    analyzed_cluster <- str_extract(basename(csv_paths), "cluster_[0-9]+")
