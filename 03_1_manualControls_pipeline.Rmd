...
mito_groups <- check_empty_groups(cplt$mito_groups, mito_groups)
...
ribo_groups <- check_empty_groups(cplt$ribo_groups, ribo_groups)
...
umi_groups <- check_empty_groups(cplt$umi_groups, umi_groups)
...
feature_groups <- check_empty_groups(cplt$feature_groups, feature_groups)
