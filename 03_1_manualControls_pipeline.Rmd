...
Groups' size:
```{r groups-size-mito}
mito_groups <- get_sorted_groups(cplt$mito_groups)
...
Groups' size:
```{r groups-size-ribo}
ribo_groups <- get_sorted_groups(cplt$ribo_groups)
...
Groups' size:
```{r groups-size-UMI}
umi_groups <- get_sorted_groups(cplt$umi_groups)
...
feature_groups <- get_sorted_groups(cplt$feature_groups)
