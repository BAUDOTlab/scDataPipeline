...
```{r crossVal_mito, results='asis', out.width='50%', fig.align='default'}
...
```{r crossVal_ribo, results='asis', out.width='50%', fig.align='default'}
...
```{r crossVal_umi, results='asis', out.width='50%', fig.align='default'}
...
```{r crossVal_feature, results='asis', out.width='50%', fig.align='default'}
