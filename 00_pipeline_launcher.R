...
if (TRUE){
    ...
    ff_list = if (!is.null(if (exists("FILTER_FEATURES")) FILTER_FEATURES else opt$options$filter_features)) if (exists("FILTER_FEATURES")) FILTER_FEATURES else strsplit(opt$options$filter_features, ",")
}
