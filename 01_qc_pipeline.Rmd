...
```{r load-data}
# Check if DATASET contains a space
if (grepl("[ ]", DATASET)) {
  stop("Error: DATASET contains a space. Please remove any spaces from the DATASET variable.")
}

# Check if DATASET ends with a space
if (grepl("[ ]$", DATASET)) {
  stop("Error: DATASET ends with a space. Please remove the trailing space from the DATASET variable and try again.")
}
