...
clusters = read.table(paste0(PATH_ROOT, "/04_process/clustering_highDiet_complete_meth.4_res.1.csv"), header = T, sep =",")

# clusters <- read.table(paste0(PATH_ROOT, "/04_process/clustering_", DATASET, "_complete_meth.", clust_meth, "_res.", clust_res, ".csv"), header = TRUE, sep = ",")
```
