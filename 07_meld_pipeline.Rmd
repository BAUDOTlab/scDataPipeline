...
knitr::opts_chunk$set(
  ...
  # plots
  fig.path = paste0(PATH_OUT_FIG, "/07_MELD_scenario_", scenario, "/"),      # is set later, in chunk setup2
...
pred = pd.read_csv(Path(r.PATH_ROOT, "07_annotDEAviz", f"transferAnnotation_combinedData_{r.DATASET}_scenario.{r.scenario}.csv"), header=0)
