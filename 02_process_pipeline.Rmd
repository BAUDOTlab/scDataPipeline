...
The preprocessing workflow contains several steps:

- data normalization,

- data centering,

- highly variable genes/features identification,
...
Visualization of cells with non-linear dimensionality reduction UMAP. Colors correspond to clusters.
...
We export the list of highly variable features as well as the PCA and UMAP coordinates
